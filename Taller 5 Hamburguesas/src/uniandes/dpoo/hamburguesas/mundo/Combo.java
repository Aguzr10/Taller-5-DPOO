...
/**
 * La clase utilizada para organizar la informaciÃ³n de un combo
 */
public class Combo implements Producto
{
    ...
    /**
     * El descuento que incluye el combo. Es un nÃºmero entre 0 y 1, donde 0 corresponde a que no hay descuento y 1 corresponde al 100% de descuento
     */
     ...
     * 
     * El precio estÃ¡ basado en aplicarle el descuento del combo al valor de cada uno de los productos.
     */
    @Override
